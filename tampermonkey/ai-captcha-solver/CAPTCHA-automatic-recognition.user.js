...
作为验证码识别专家，你必须遵守上述Rules，按照Workflows执行任务。`;
    ...
    data() {
      return {
        ...
        settings: {
          ...
          // 规则 URL
          rulesUrl: "https://ghfast.top/https://raw.githubusercontent.com/anghunk/UserScript/main/CAPTCHA-automatic-recognition/rules.json"
          // 规则文件 URL
        },
        // 是否显示设置面板
        showSettings: false,
    ...
    methods: {
      ...
      async loadRules() {
        try {
          ...
          let rulesData;
          const rulesUrl = this.settings.rulesUrl || "https://ghfast.top/https://raw.githubusercontent.com/anghunk/UserScript/main/CAPTCHA-automatic-recognition/rules.json";
  ...
  const _hoisted_17 = /* @__PURE__ */ vue.createElementVNode("option", { value: "ddddocr" }, "ddddocr", -1);
  const _hoisted_18 = [
    _hoisted_14,
    _hoisted_15,
    _hoisted_16,
  ...
  const _hoisted_80 = /* @__PURE__ */ vue.createElementVNode("label", null, "自定义 API 地址 (可选):", -1);
  const _hoisted_81 = { class: "textarea-with-button" };
  ...
  const _hoisted_85 = /* @__PURE__ */ vue.createElementVNode("label", null, "自定义 Request 请求模板:", -1);
  const _hoisted_86 = { class: "textarea-with-button" };
  const _hoisted_87 = /* @__PURE__ */ vue.createElementVNode("small", null, "留空使用默认模板", -1);
  const _hoisted_88 = {
    key: 1,
    class: "settings-content-tab"
  };
  ...
  const _hoisted_92 = { style: { "display": "flex", "align-items": "center" } };
  const _hoisted_93 = /* @__PURE__ */ vue.createElementVNode("label", {
    for: "autoRecognize",
    style: { "margin-bottom": "0" }
  }, "验证码图片变化时自动识别", -1);
  const _hoisted_94 = { class: "captcha-settings-item" };
  const _hoisted_95 = { style: { "display": "flex", "align-items": "center" } };
  const _hoisted_96 = /* @__PURE__ */ vue.createElementVNode("label", {
    for: "copyToClipboard",
    style: { "margin-bottom": "0" }
  }, "自动复制到剪贴板", -1);
  const _hoisted_97 = { class: "captcha-settings-item" };
  const _hoisted_98 = { style: { "display": "flex", "align-items": "center" } };
  const _hoisted_99 = /* @__PURE__ */ vue.createElementVNode("label", {
    for: "showNotification",
    style: { "margin-bottom": "0" }
  }, "显示右上角通知提示", -1);
  const _hoisted_100 = { class: "captcha-settings-item" };
  const _hoisted_101 = { style: { "display": "flex", "align-items": "center" } };
  const _hoisted_102 = /* @__PURE__ */ vue.createElementVNode("label", {
  ...
  const _hoisted_104 = { class: "settings-card" };
  const _hoisted_105 = /* @__PURE__ */ vue.createElementVNode("div", { class: "settings-card-title" }, [
    /* @__PURE__ */ vue.createElementVNode("span", null, "禁用域名列表")
  ], -1);
  const _hoisted_106 = { class: "captcha-settings-item" };
  const _hoisted_107 = /* @__PURE__ */ vue.createElementVNode("small", null, [
  ...
  const _hoisted_109 = { class: "settings-card" };
  const _hoisted_110 = /* @__PURE__ */ vue.createElementVNode("div", { class: "settings-card-title" }, [
  ...
  const _hoisted_111 = /* @__PURE__ */ vue.createElementVNode("div", { class: "advanced-settings-warning" }, " ⚠️ 警告：如果您不了解 CSS 选择器，请不要修改这些设置，可能导致识别功能失效 ", -1);
  const _hoisted_112 = { class: "captcha-settings-item" };
  const _hoisted_113 = /* @__PURE__ */ vue.createElementVNode("label", null, "自定义验证码图片选择器：", -1);
  const _hoisted_114 = { class: "custom-selectors" };
  const _hoisted_115 = ["onUpdate:modelValue"];
  const _hoisted_116 = ["onClick"];
  const _hoisted_117 = { class: "captcha-settings-item" };
  const _hoisted_118 = /* @__PURE__ */ vue.createElementVNode("label", null, "自定义输入框选择器：", -1);
  const _hoisted_119 = { class: "custom-selectors" };
  const _hoisted_120 = ["onUpdate:modelValue"];
  const _hoisted_121 = ["onClick"];
  const _hoisted_122 = { class: "captcha-settings-item" };
  const _hoisted_123 = /* @__PURE__ */ vue.createElementVNode("label", null, "验证码规则管理：", -1);
  const _hoisted_124 = { class: "rules-management" };
  const _hoisted_125 = { class: "rules-url-input" };
  const _hoisted_126 = /* @__PURE__ */ vue.createElementVNode("small", null, "规则文件 URL，留空则使用默认 URL：https://ghfast.top/https://raw.githubusercontent.com/anghunk/UserScript/main/CAPTCHA-automatic-recognition/rules.json", -1);
  const _hoisted_127 = { key: 0 };
  const _hoisted_128 = { key: 1 };
  const _hoisted_129 = { key: 2 };
  const _hoisted_130 = { key: 3 };
  const _hoisted_131 = /* @__PURE__ */ vue.createElementVNode("small", null, "从远程加载最新的验证码识别规则", -1);
  const _hoisted_132 = { class: "captcha-settings-buttons" };
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
      ...
      $data.showSettings ? (vue.openBlock(), vue.createElementBlock("div", {
        ...
        onClick: _cache[42] || (_cache[42] = vue.withModifiers(() => {
        }, ["stop"]))
      }, [
        vue.createElementVNode("div", _hoisted_4, [
          ...
          vue.createElementVNode("div", _hoisted_6, [
            $data.activeSettingTab === "ai" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_7, [
              vue.createElementVNode("div", _hoisted_8, [
                ...
                $data.settings.apiType === "ddddocr" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_73, [
                  vue.createElementVNode("div", _hoisted_74, [
                    vue.createElementVNode("button", {
                      ...
                      type: "button",
                      onClick: _cache[25] || (_cache[25] = ($event) => $options.testApiConnection("ddddocr"))
                    }, [
                      $data.apiTestStatus.ddddocr === "" ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_75, "测试连接")) : $data.apiTestStatus.ddddocr === "loading" ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_76)) : $data.apiTestStatus.ddddocr === "success" ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_77, "成功")) : $data.apiTestStatus.ddddocr === "error" ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_78, "失败")) : vue.createCommentVNode("", true)
                    ], 2)
                  ]),
                  vue.createElementVNode("div", _hoisted_79, [
                    ...
                    vue.createElementVNode("div", _hoisted_81, [
                      vue.withDirectives(vue.createElementVNode("input", {
                        "onUpdate:modelValue": _cache[26] || (_cache[26] = ($event) => $data.settings.ddddocrApiUrl = $event),
                      ...
                      vue.createElementVNode("button", {
                        class: "use-default-prompt",
                        type: "button",
                        onClick: _cache[27] || (_cache[27] = ($event) => $data.settings.ddddocrApiUrl = $data.ddddocrApiDefaultUrl)
                      }, " 默认 ")
                    ]),
                    _hoisted_83
                  ]),
                  vue.createElementVNode("div", _hoisted_84, [
                    ...
                    vue.createElementVNode("div", _hoisted_86, [
                      vue.withDirectives(vue.createElementVNode("textarea", {
                        ref: "jsontextareaRef",
                        "onUpdate:modelValue": _cache[28] || (_cache[28] = ($event) => $data.settings.ddddocrApiTemplate = $event),
                        onInput: _cache[29] || (_cache[29] = (...args) => $options.autoResize && $options.autoResize(...args))
                      }, null, 544), [
                      ...
                      vue.createElementVNode("button", {
                        class: "use-default-prompt",
                        type: "button",
                        onClick: _cache[30] || (_cache[30] = ($event) => $data.settings.ddddocrApiTemplate = $data.ddddocrApiDefaultTemplate)
                      }, " 使用默认 ")
                    ]),
                    _hoisted_87
                  ])
            ...
            $data.activeSettingTab === "function" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_88, [
              vue.createElementVNode("div", _hoisted_89, [
                ...
                vue.createElementVNode("div", _hoisted_91, [
                  vue.createElementVNode("div", _hoisted_92, [
                    vue.withDirectives(vue.createElementVNode("input", {
                      type: "checkbox",
                      "onUpdate:modelValue": _cache[31] || (_cache[31] = ($event) => $data.settings.autoRecognize = $event),
                      id: "autoRecognize",
                ...
                vue.createElementVNode("div", _hoisted_94, [
                  vue.createElementVNode("div", _hoisted_95, [
                    vue.withDirectives(vue.createElementVNode("input", {
                      type: "checkbox",
                      "onUpdate:modelValue": _cache[32] || (_cache[32] = ($event) => $data.settings.copyToClipboard = $event),
                      id: "copyToClipboard",
                      style: { "width": "auto", "margin-right": "8px !important" }
                    }, null, 512), [
                ...
                vue.createElementVNode("div", _hoisted_97, [
                  vue.createElementVNode("div", _hoisted_98, [
                    vue.withDirectives(vue.createElementVNode("input", {
                      type: "checkbox",
                      "onUpdate:modelValue": _cache[33] || (_cache[33] = ($event) => $data.settings.showNotification = $event),
                      id: "showNotification",
                      style: { "width": "auto", "margin-right": "8px !important" }
                    }, null, 512), [
                ...
                vue.createElementVNode("div", _hoisted_100, [
                  vue.createElementVNode("div", _hoisted_101, [
                    vue.withDirectives(vue.createElementVNode("input", {
                      type: "checkbox",
                      "onUpdate:modelValue": _cache[34] || (_cache[34] = ($event) => $data.settings.autoFetchCloudRules = $event),
            ...
            $data.activeSettingTab === "domain" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_103, [
              vue.createElementVNode("div", _hoisted_104, [
                _hoisted_105,
                vue.createElementVNode("div", _hoisted_106, [
                  vue.withDirectives(vue.createElementVNode("textarea", {
                    "onUpdate:modelValue": _cache[35] || (_cache[35] = ($event) => $data.settings.disabledDomains = $event),
            ...
            $data.activeSettingTab === "advanced" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_108, [
                ...
                vue.createElementVNode("div", _hoisted_112, [
                  ...
                  vue.createElementVNode("div", _hoisted_114, [
                    ...
                    vue.createElementVNode("button", {
                      type: "button",
                      class: "add-selector",
                      onClick: _cache[36] || (_cache[36] = ($event) => $options.addSelector("captcha"))
                    }, " 添加选择器 ")
                  ])
                ]),
                vue.createElementVNode("div", _hoisted_117, [
                  ...
                  vue.createElementVNode("div", _hoisted_119, [
                    ...
                    vue.createElementVNode("button", {
                      type: "button",
                      class: "add-selector",
                      onClick: _cache[37] || (_cache[37] = ($event) => $options.addSelector("input"))
                    }, " 添加选择器 ")
                  ])
                ]),
                vue.createElementVNode("div", _hoisted_122, [
                  ...
                  vue.createElementVNode("div", _hoisted_124, [
                    vue.createElementVNode("div", _hoisted_125, [
                      vue.withDirectives(vue.createElementVNode("input", {
                        type: "text",
                        "onUpdate:modelValue": _cache[38] || (_cache[38] = ($event) => $data.settings.rulesUrl = $event),
                    ...
                    vue.createElementVNode("button", {
                      ...
                      onClick: _cache[39] || (_cache[39] = (...args) => $options.reloadRules && $options.reloadRules(...args))
                    }, [
                      $data.rulesLoadStatus === "" ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_127, "重新加载规则")) : $data.rulesLoadStatus === "loading" ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_128)) : $data.rulesLoadStatus === "success" ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_129, "加载成功")) : $data.rulesLoadStatus === "error" ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_130, "加载失败")) : vue.createCommentVNode("", true)
                    ], 2),
                    _hoisted_131
                  ])
                ])
          ...
          vue.createElementVNode("div", _hoisted_132, [
            vue.createElementVNode("button", {
              onClick: _cache[40] || (_cache[40] = (...args) => $options.saveSettings && $options.saveSettings(...args))
            }, "保存设置"),
            vue.createElementVNode("button", {
              onClick: _cache[41] || (_cache[41] = (...args) => $options.closeSettings && $options.closeSettings(...args))
            }, "取消")
          ])
        ])
