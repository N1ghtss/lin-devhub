              ...
              <div class="captcha-settings-item">
                ...
                <div class="rules-management">
                  <div class="rules-url-input">
                    ...
                    />
                    <small
                    >规则文件 URL，留空则使用默认 URL：https://ghfast.top/https://raw.githubusercontent.com/anghunk/UserScript/main/CAPTCHA-automatic-recognition/rules.json</small
                    >
                  </div>
                  <button
                    type="button"
  ...
  data() {
    return {
      ...
      settings: {
        ...
        // 规则 URL
        rulesUrl:
            "https://ghfast.top/https://raw.githubusercontent.com/anghunk/UserScript/main/CAPTCHA-automatic-recognition/rules.json", // 规则文件 URL
      },
      // 是否显示设置面板
      showSettings: false,
      // 当前激活的设置标签页
